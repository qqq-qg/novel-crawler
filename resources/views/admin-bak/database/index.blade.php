        ...
        @if(count($lists) > 0)
            @foreach($lists as $v)
                <tr>
                    ...
                    <td>
                        <div class="progress">
                            <div style="width: {{ ($v['Data_length'] == 0 || $v['Max_data_length'] == 0) ? 0 : ceil($v['Data_length']/$v['Max_data_length']) }}%"
                                 aria-valuemax="100" aria-valuemin="0" aria-valuenow="35" role="progressbar"
