        ...
        @if(count($lists) > 0)
            @foreach($lists as $v)
                <tr id="book_{{ $v['id'] }}">
                    ...
                    <td>{{ $v['id'] }}</td>
                    <td>{{ $categories[$v['cate_id']]['name']??'' }}</td>
                    <td align="left"><strong>{{ $v['title'] }}</strong></td>
                    <td><i class="fa fa-file-image-o" onclick="preview('{!! bookimg($v['thumb']) !!}',210,280)"></i>
                    </td>
                    <td>{{ $v['last_chapter_title'] }}</td>
                    <td>{{ $v['author'] }}</td>
                    <td>{{ $v['wordcount'] }}</td>
                    <td>{{ $v['follow'] }}</td>
                    <td>{{ $v['hits'] }}</td>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block m-b-none">具体小说名称</span>
                            </div>
                        </div>
                    </div>
                ...
                <form action="{{ route('Book.updateQueue') }}" method="post" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="updateType" class="form-control"
                                        onchange="changeUpdateQueueFormType(this.value);">
                            ...
                            <div class="col-sm-9">
                                @foreach($categories??[] as $v)
                                    <label class="i-checks">
                                        <input type="checkbox" name="cate_id[]" value="{{ $v['id'] }}">
                                        {{ $v['name'] }}
                                    </label>
                                @endforeach
                                <span class="help-block m-b-none"></span>
                        ...
                        <div class="form-group updateType hidden" id="updateType_2">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="startId" value="{{ old('startId') }}"
                                       placeholder="100">
                                <span class="help-block m-b-none">起始ID</span>
                                <input type="number" class="form-control" name="endId" value="{{ old('endId') }}"
                                       placeholder="100">
                        ...
                        <div class="form-group updateType hidden" id="updateType_3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="targetId" value="{{ old('targetId') }}"
                                       placeholder="89757">
                                <span class="help-block m-b-none"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group xiaoshuoNumber">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="book_number"
                                       value="{{ old('book_number') }}" placeholder="100">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="chapter_number"
                                       value="{{ old('chapter_number') }}" placeholder="100">
                ...
                <form action="{{ route('Book.postUpdate') }}" method="POST" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="introduce" id="" cols="30" rows="10"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="last_chapter_title"
                                       value="" placeholder="">
                                <span class="help-block m-b-none"></span>
                            </div>
                        </div>
