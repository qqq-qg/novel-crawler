    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            <li class="nav-header">
              ...
              <span class="clear">
                <span class="block m-t-xs"><strong class="font-bold">Nacrane</strong></span>
                    ...
                    @if(isset($v['child']))
                        <ul class="nav nav-second-level">
                            @foreach($v['child'] as $vv)
                                <li><a class="J_menuItem {{ Request::getUri() == $vv['url'] ? 'current' : '' }}"
                                       href="{{ $vv['url'] }}"><i class="{{ $vv['ico'] }}"></i>{{ $vv['name'] }}</a>
                                </li>
                            @endforeach
                        </ul>
                    @endif
